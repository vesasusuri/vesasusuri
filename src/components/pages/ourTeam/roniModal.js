...
//           <Modal.Title className='name'>Ron Kasemi</Modal.Title>
//         </Modal.Header>
        ...
        <Modal.Header closeButton>
          <div className="alldiv">
            ...
            <div className="modalNames">
              <Modal.Title className='name'>Ron Kasemi</Modal.Title>
              <Modal.Title className="name2">COO</Modal.Title>
            </div>
            <Modal.Body className="skills">.skills</Modal.Body>
            <div className="divSkills">
              <Modal.Body className="skills01">#coo</Modal.Body>
