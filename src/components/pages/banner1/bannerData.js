...
const Data = [
    {
        ...
        btnbanner1digilab:<Link className="learn"><FormattedMessage id="learn-more" defaultMessage=".logIn()"/></Link>,
        btnbanner2digilab:<Link className="learn"><FormattedMessage id="learn-more" defaultMessage=".signUp()"/></Link>
    }
]
